...
@section('content')
<div class="container">
    <h1 class="mt-5 mb-4 text-center">Table Daftar Suppliers Pemesanan Bengkel</h1>
    <a href="{{ route('suppliers.create') }}" class="btn btn-primary mb-4">Tambah Supplier Baru</a>
